// Client half of @canary-builds/dsh-mobile-ui: app-style collapsed sidebar.
...
window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const tagId = "@canary-builds/dsh-mobile-ui/whale.css";
		if (typeof document !== "undefined") {
			...
			if (existing !== null) existing.textContent = css;
				...
				tag.dataset.plugin = "@canary-builds/dsh-mobile-ui";
